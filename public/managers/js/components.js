...
$(document).ready((function() {
    if (notyf = new Notyf({
        ...
        }))), FilePond.registerPlugin(FilePondPluginImagePreview, FilePondPluginImageExifOrientation, FilePondPluginFileValidateSize, FilePondPluginImageEdit), $(".filepond").length && FilePond.create(document.querySelector(".filepond")), $(".filepond-2-grid").length && FilePond.create(document.querySelector(".filepond-2-grid")), $(".filepond-3-grid").length && FilePond.create(document.querySelector(".filepond-3-grid")), $(".profile-filepond").length && FilePond.create(document.querySelector(".profile-filepond"), {
        ...
        }), $(".profile-filepond-small").length && FilePond.create(document.querySelector(".profile-filepond-small"), {
            labelIdle: '<i class="lnil lnil-cloud-upload"></>',
            ...
            styleButtonRemoveItemPosition: "left bottom",
            styleButtonProcessItemPosition: "right bottom"
        }), $(".profile-filepond-tiny").length && FilePond.create(document.querySelector(".profile-filepond-tiny"), {
            labelIdle: '<i class="lnil lnil-cloud-upload"></>',
            ...
            styleButtonRemoveItemPosition: "left bottom",
            styleButtonProcessItemPosition: "right bottom"
        }), $(".square-filepond").length && FilePond.create(document.querySelector(".square-filepond"), {
            ...
            styleButtonRemoveItemPosition: "left bottom",
            styleButtonProcessItemPosition: "right bottom"
        }), $(".square-filepond-small").length && FilePond.create(document.querySelector(".square-filepond-small"), {
            labelIdle: '<i class="lnil lnil-plus"></>',
            imagePreviewHeight: 110,
            imageCropAspectRatio: "1:1",
            imageResizeTargetWidth: 110,
            ...
            styleButtonRemoveItemPosition: "left bottom",
            styleButtonProcessItemPosition: "right bottom"
        }), $(".square-filepond-tiny").length && FilePond.create(document.querySelector(".square-filepond-tiny"), {
            labelIdle: '<i class="lnil lnil-plus"></>',
            imagePreviewHeight: 80,
            imageCropAspectRatio: "1:1",
            imageResizeTargetWidth: 80,
        ...
        $("#pickaday-datepicker").length) new Pikaday({
    ...
    if ($("#choices-multiple-remove-button").length) new Choices("#choices-multiple-remove-button", {
        removeItemButton: !0
    });
    ...
    if ($(".noui-base-slider").length)
        for (var e = document.getElementsByClassName("noui-base-slider"), t = 0; t < e.length; t++) noUiSlider.create(e[t], {
            start: [10, 90],
            connect: !0,
