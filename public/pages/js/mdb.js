    ...
    (n = [
      ...
      function (M, t, e) {
        ...
        function ke(e) {
          ...
          const i = e.NAME
          f.on(document, t, '[data-mdb-dismiss="'.concat(i, '"]'), function (
            t,
          ) {
        ...
        f.on(document, _, '[data-mdb-slide], [data-mdb-slide-to]', function (
          t,
        ) {
          var e = l(this)
          e &&
        ...
        function qi(t) {
          return 'html' === C(t)
            ? t
            : t.assignedSlot || t.parentNode || (ki(t) ? t.host : null) || Fi(t)
        }
