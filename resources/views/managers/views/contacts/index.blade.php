    ...
    <div class="page-content is-relative">
        ...
        <div class="page-title has-text-centered">
            ...
            <div class="title-wrap">
                <h1 class="title is-4">Contactenos</h1>
            </div>
                ...
                <table id="users-datatable" class="table is-datatable is-hoverable table-is-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (strlen($item->names) > 5)
                             <td>{{ substr($item->names, 0, 18) . '...' }}</td>
                            @endif

                            <td>
                                @if ($item->reviewed == 1)

                                <span class="tag is-success is-rounded is-busy">Revisado</span>


                                @else
                                <span class="tag is-success is-rounded">Pendiente</span>
                            ...
                            <td>
                                <div class="row-action">
                                    <div class="dropdown is-spaced is-dots is-right dropdown-trigger">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <div class="dropdown-content">
                                                <a href="{{ route('manager.edit.contacts', $item->slack) }}" class="dropdown-item is-media">
                                                ...
                                                <a class="dropdown-item is-media h-modal-delete" data-modal="delete-modal" data-href="/manager/contacts/destroy/" data-slack="{{ $item->slack }}">
