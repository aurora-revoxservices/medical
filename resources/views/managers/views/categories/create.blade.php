            ...
            <div class="page-content is-relative">
                <div class="page-title has-text-centered">
                    ...
                    <div class="title-wrap">
                        <h1 class="title is-4">Crear categoría</h1>
                    </div>
                ...
                <div class="page-content-inner">
                    ...
                    {!! Form::open(['route' => ['manager.storage.categories'], 'method' => 'POST', 'id' => 'formBlogs' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
