            ...
            <div class="page-content is-relative">
                ...
                <div class="page-title has-text-centered">
                    ...
                    <div class="title-wrap">
                        <h1 class="title is-4">Crear pregunta</h1>
                    </div>
                ...
                <div class="page-content-inner">
                    <!--Form Layout 1-->
                    {!! Form::open(['route' => ['manager.storage.faqs'], 'method' => 'POST', 'id' => 'formFaqs' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                                            ...
                                            <div class="field">
                                                ...
                                                <div>
                                                    <input type="text" name="label"
                                                        value="" class="input" placeholder="" autofocus >
                                                </div>
                                            </div>
                                        </div>
