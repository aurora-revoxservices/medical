...
<div class="page-content-wrapper">
    <div class="page-content is-relative">
        ...
        <div class="datatable-toolbar">
            ...
            <div class="buttons">
                <a href="{{ route('manager.create.teams') }}" class="button h-button is-primary is-elevated">
                    <span class="icon">
                            ...
                            <td>
                                <div class="row-action">
                                    <div class="dropdown is-spaced is-dots is-right dropdown-trigger">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <div class="dropdown-content">
                                                <a href="{{ route('manager.edit.teams', $item->slack) }}" class="dropdown-item is-media">
                                                    <div class="icon">
                                                ...
                                                <a class="dropdown-item is-media h-modal-delete" data-modal="delete-modal" data-href="/manager/teams/destroy/" data-slack="{{ $item->slack }}">
