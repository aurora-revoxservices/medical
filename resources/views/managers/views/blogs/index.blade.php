...
<div class="page-content-wrapper">
    <div class="page-content is-relative">
        ...
        <div class="datatable-toolbar">
            ...
            <div class="buttons">
                <a href="{{ route('manager.create.blogs') }}" class="button h-button is-primary is-elevated">
                    <span class="icon">
                ...
                <table id="users-datatable" class="table is-datatable is-hoverable table-is-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if (strlen($item->label) > 18)
                                <span class="has-dark-text dark-inverted is-font-alt  rem-90">{{ substr($item->label, 0, 32) . '...' }}</span>
                                @else
                                <span class="has-dark-text dark-inverted is-font-alt  rem-90">{{ $item->label }}</span>
                                @endif
                            </td>
                            <td>{{ $item->categorie->label }}</td>
                            <td>
                            ...
                            <td>
                                <div class="row-action">
                                    <div class="dropdown is-spaced is-dots is-right dropdown-trigger">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <div class="dropdown-content">
                                                <a href="{{ route('manager.edit.blogs', $item->slack) }}" class="dropdown-item is-media">
                                                    <div class="icon">
                                                ...
                                                <a class="dropdown-item is-media h-modal-delete" data-modal="delete-modal" data-href="/manager/blogs/destroy/" data-slack="{{ $item->slack }}">
                                                    <div class="icon">
