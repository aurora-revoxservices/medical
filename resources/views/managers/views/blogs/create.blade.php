        ...
        <div class="page-content is-relative">
            <div class="page-title has-text-centered">
                ...
                <div class="title-wrap">
                    <h1 class="title is-4">Crear blog</h1>
                </div>
            ...
            <div class="page-content-inner">
                ...
                {!! Form::open(['route' => ['manager.storage.blogs'], 'method' => 'POST', 'id' => 'formBlogs' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                {{ csrf_field() }}
                                ...
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-12">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input type="text" name="sentence" class="input" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="column is-12">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input type="text" name="date" class="input" id="date" placeholder="">
                                            </div>
                                        </div>
                                    </div>
